...
// Viewing the available data fromt the data.js
...
button.on("click", () => {
  ...
  var filterDate = tableData.filter(
    (tableData) => tableData.datetime === inputDate
  );
...
//var filterCity = tableData.filter(
//(tableData) => tableData.city === inputCity
//);
...
//var filterCombinedData = tableData.filter(
//  (tableData) =>
//    tableData.datetime === inputDate && tableData.city === inputCity
//);
...
//   // }
//   else if (
//     response.filterCombinedData.length === 0 &&
//     (response.filterDate.length !== 0 || response.filterCity.length !== 0)
//   ) {
